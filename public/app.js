...
async function updateCounter(){
 try{
  ...
  liveNumber.textContent=n.toLocaleString();
  liveNumber.style.opacity=n>0?"1":"0";
  liveFill.style.opacity=n>0?"1":"0";
  liveFill.style.transform=`scaleX(${n/1000})`;
 }catch(e){
  liveNumber.style.opacity="0";
  liveFill.style.opacity="0";
